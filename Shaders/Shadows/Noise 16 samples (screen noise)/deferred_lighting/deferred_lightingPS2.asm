...
//
    ...
    def c5, 1.5, -0.326211989, -0.405809999, 0.0625				//  1/16  samples
	...
	//
		...
		def c99, 2.0, -1.0, 0.0, 0.0		// rand constants rescale [-1, 1]
		
		def c100, 1298.6400725, 7670.22014, 2046.3652500, 8931.23984
		def c101, 2405.8499925, 3194.98306, 6183.5850025, 4800.26007
		def c102, 1739.7849250, 4571.36989, 9508.3625025, 6207.15976
		def c103, 8155.2997252, 5058.09999, 2100.3599475, 7073.57997
		def c104, -0.5, 0.5, 0.0199999996, 0.00399999978
	...
	mul r1.xy, r1.xy, c2.xx
	mov r2.zw, c9.zz				// r2.zw = zero (avoid trouble on sampling)
	mov r5.xyzw, c9.zzzz			// r5 = 0
	mov r4.z, c9.z					// r4.z = 0
	...
	// texld r11, v0.xy, s4
	mov r13.xy, c106.xy
	mul r12.xy, r13.xy, c104.yy	// uv to sample
	// mul r11.xy, r11.xy, c4.zz
	add r12.xy, r12.xy, v0.xy
	// vec2 rand(vec2 uv){
	...
	mul r4.xy, r12.xy, c100.xy // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.x, r4.x
	sincos r6.y, r4.y
	mul r4.xy, r6.xy, c98.zw // c98.zw = {33718.5453, 43758.5453}
	frc r4.xy, r4.xy
	mad r4.xy, r4.xy, c99.xx, c99.yy // c99.xy = {2.0, -1.0}
	mad r4.xy, r4.xy, r11.xy, r10.xy
	texld r6, r4.xy, s15
	add r5.x, r1.z, -r6.x
	cmp r0.z, r5.x, c4.z, c4.w
	
	mul r4.xy, r12.xy, c100.yx // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c100.zw // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c100.wz // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c101.xy // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c101.yx // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c101.zw // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c101.wz // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c102.xy // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c102.yx // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c102.zw // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c102.wz // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c103.xy // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c103.yx // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c103.zw // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
	...
	mul r4.xy, r12.xy, c103.wz // c98.zw = {33718.5453, 43758.5453}
	mov r5.xy, c98.xy // c98.xy = {12.9898, 78.233}
	dp3 r4.xy, r5.xyz, r4.xyz
	sincos r6.xy, r4.x
	// sincos r6.y, r4.y
