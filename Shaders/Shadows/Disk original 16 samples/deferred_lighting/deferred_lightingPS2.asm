...
//
    ...
    def c5, 1.5, -0.326211989, -0.405809999, 0.0833333358			//  1/12  samples
	...
	// shadow filtering
    mad r2.xy, r11.xy, c5.yz, r10.xy
    texld r2, r2.xy, s15
    add r1.x, r1.z, -r2.x
    cmp r1.x, r1.x, c4.z, c4.w
	
    mad r2.xy, r11.xy, c16.xy, r10.xy	
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c16.zw, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c13.xy, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c13.zw, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c12.xy, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c12.zw, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c11.xy, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c11.zw, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c10.xy, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c10.zw, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r11.xy, c6.xy, r10.xy
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c4.z, c4.w
    add r0.z, r1.x, r1.w
