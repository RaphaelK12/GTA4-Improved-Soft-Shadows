...
//
	...
	mad r2.xy, r11.xy,  c9.xy, r10.xy;
	texld r2, r2, s15;
	add r1.w, r1.z, -r2.x;
	cmp r1.w, r1.w, c3.x, c3.y;
	add r1.x, r1.x, r1.w;

	mad r2.xy, r11.xy,  c9.zw, r10.xy;
	texld r2, r2, s15;
	add r1.w, r1.z, -r2.x;
	cmp r1.w, r1.w, c3.x, c3.y;
	add r1.x, r1.x, r1.w;

	mad r2.xy, r11.xy,  c8.xy, r10.xy;
	texld r2, r2, s15;
	add r1.w, r1.z, -r2.x;
	cmp r1.w, r1.w, c3.x, c3.y;
	add r1.x, r1.x, r1.w;

	mad r2.xy, r11.xy,  c8.zw, r10.xy;
	texld r2, r2, s15;
	add r1.w, r1.z, -r2.x;
	cmp r1.w, r1.w, c3.x, c3.y;
	add r0.z, r1.x, r1.w;
	...
	mul r0.y, r0.w, r0.w
	mul r0.y, r0.y, c3.z
	mad r0.y, r0.z, c3.w, r0.y // c3.w = 1/samples count
	add r0.z, r1.y, r0.y
