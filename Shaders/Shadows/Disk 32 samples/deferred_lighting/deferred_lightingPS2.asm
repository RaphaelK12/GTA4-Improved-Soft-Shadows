...
//
    ...
    def c5, 1.5, -0.326211989, -0.405809999, 0.03125				//  1/32 samples
	...
	//
	    def c97,  0.1250, 0.5, 0.25, 2 // texture rescale multiplicator
		def c96, -1, 0, 1, 2 	// pixels offsets

		// New poison Disk 32 samples (rescaled x/2, y*2)
		def c101, -0.221866, -0.934692, -0.868741, -0.447062
		def c102,  0.228646, -0.198736,  0.955854, -0.010131
		def c103,  0.000000,  0.000000,  0.225405, -0.952712
		def c104,  0.352948, -0.468460, -0.238958, -0.546762
		def c105, -0.570146,  0.815342, -0.039776,  0.305063
		def c106,  0.058898, -0.603246, -0.975372, -0.013183
		def c107,  0.236543,  0.949464, -0.051084,  0.614075
		def c108,  0.576297,  0.725291, -0.509027, -0.369782
		def c109, -0.849727,  0.434967,  0.884918,  0.457409
		def c100,  0.258664,  0.536653,  0.264437,  0.156282
		def c111, -0.200532,  0.923337,  0.870215, -0.470716
		def c112, -0.516391,  0.252394, -0.157007, -0.260674
		def c113,  0.530300,  0.341894,  0.588371,  0.038806
		def c114,  0.607545, -0.749024,  0.565693, -0.259781
		def c115, -0.352264,  0.512090, -0.306225,  0.027380
		def c116, -0.596477, -0.056107, -0.606775, -0.779587
