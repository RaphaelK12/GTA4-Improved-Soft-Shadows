...
//
    ...
    def c5, 1.5, -0.326211989, -0.405809999, 1 					//  1/1 samples
	...
	// 00
	mad r2.xy, c96.yy, r11.xy, r10.xy;
	texld r4, r2.xy, s15;
	add r3.x, r1.z, -r4.x;
	cmp r3.x, r3.x, c4.z, c4.w
	// 01
	mad r2.xy, c96.zy, r11.xy, r10.xy;
	texld r4, r2.xy, s15;
	add r3.y, r1.z, -r4.x;
	cmp r3.y, r3.y, c4.z, c4.w
	// 10
	mad r2.xy, c96.yz, r11.xy, r10.xy;
	texld r4, r2.xy, s15;
	add r3.z, r1.z, -r4.x;
	cmp r3.z, r3.z, c4.z, c4.w
	// 11
	mad r2.xy, c96.zz, r11.xy, r10.xy;
	texld r4, r2.xy, s15;
	add r3.w, r1.z, -r4.x;
	...
	mul r2.xy, r10.xy, r2.xy	// uv * texture size(ex. 2048x512)
	frc r2.xy, r2.xy			// fractional part
	add r2.xy, c9.xx, -r2.xy	// 1 - fractional part
	// fractional part of pixel coord //lrp dst, src0, src1, src2 // dest = src0 * src1 + (1-src0) * src2
	
	//vertical lerp
	lrp r4.xy, r2.y, r3.xy, r3.zw	// vertical linear interpolate betwin row 0 and row 1	
	lrp r0.z, r2.x, r4.x, r4.y		// horizontal linear interpolate betwin colum 0 and colum 1	
