...
//
	...
	def c101, 0.0000,  0.0000,  0.1875, -0.5000 
	def c102, 0.0000,  0.2500,  0.2500,  0.0000 
	def c103, 0.0000,  0.5000,  0.2500,  0.2500 
	def c104, 0.0000,  0.7500,  0.2500, -0.2500 
	def c105, 0.0000,  1.0000, -0.0625,  0.0000 
	def c106, 0.0000, -0.2500, -0.0625,  0.2500 
	def c107, 0.0000, -0.5000, -0.0625,  0.5000 
	def c108, 0.0000, -0.7500, -0.0625,  0.7500 
	def c109, 0.0000, -1.0000, -0.0625,  1.0000 
	def c100, 0.0625,  0.0000, -0.0625, -0.2500 
	def c111, 0.0625,  0.2500, -0.0625, -0.5000 
	def c112, 0.0625,  0.5000, -0.0625, -0.7500 
	def c113, 0.0625,  0.7500, -0.0625, -1.0000 
	def c114, 0.0625,  1.0000, -0.1250,  0.0000 
	def c115, 0.0625, -0.2500, -0.1250,  0.2500 
	def c116, 0.0625, -0.5000, -0.1250,  0.5000 
	def c117, 0.0625, -0.7500, -0.1250,  0.7500 
	def c118, 0.0625, -1.0000, -0.1250, -0.2500 
	def c119, 0.1250,  0.0000, -0.1250, -0.5000 
	def c120, 0.1250,  0.2500, -0.1250, -0.7500 
	def c121, 0.1250,  0.5000, -0.1875,  0.0000 
	def c122, 0.1250,  0.7500, -0.1875,  0.2500 
	def c123, 0.1250, -0.2500, -0.1875,  0.5000 
	def c124, 0.1250, -0.5000, -0.1875, -0.2500 
	def c125, 0.1250, -0.7500, -0.1875, -0.5000 
	def c126, 0.1875,  0.0000, -0.2500,  0.0000 
	def c127, 0.1875,  0.2500, -0.2500,  0.2500 
	def c128, 0.1875,  0.5000, -0.2500, -0.2500 
	def c129, 0.1875, -0.2500,                                       57.00,  0.0175438596 // 1/57 samples
