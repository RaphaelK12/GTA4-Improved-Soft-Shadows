...
//
    ...
    def c5, 2, -1, 0.125, 0
    def c6, 256, 2, 4, 8
	def c10, 1.333, 0.0013888888888889, 1, 1
	def c11, 0.67, 2, 3, 0.0208333333333333
	...
	// second ring
	def c104, 1.000000, 0.000000, 0.923880, 0.382683
	def c105, 0.707107, 0.707107, 0.382683, 0.923880
	def c106, -0.000000, 1.000000, -0.382684, 0.923879
	def c107, -0.707107, 0.707107, -0.923880, 0.382683
	def c108, -1.000000, -0.000000, -0.923879, -0.382684
	def c109, -0.707106, -0.707107, -0.382683, -0.923880
	def c110, 0.000000, -1.000000, 0.382684, -0.923879
	def c111, 0.707107, -0.707107, 0.923880, -0.382683
	// third ring
	def c112, 1.000000, 0.000000, 0.965926, 0.258819
	def c113, 0.866025, 0.500000, 0.707107, 0.707107
	def c114, 0.500000, 0.866026, 0.258819, 0.965926
	def c115, -0.000000, 1.000000, -0.258819, 0.965926
	def c116, -0.500000, 0.866025, -0.707107, 0.707107
	def c117, -0.866026, 0.500000, -0.965926, 0.258819
	def c118, -1.000000, -0.000000, -0.965926, -0.258820
	def c119, -0.866025, -0.500000, -0.707106, -0.707107
	def c120, -0.499999, -0.866026, -0.258819, -0.965926
	def c121, 0.000000, -1.000000, 0.258819, -0.965926
	def c122, 0.500000, -0.866025, 0.707107, -0.707107
	def c123, 0.866026, -0.499999, 0.965926, -0.258818
	...
	mov r21, c11
	mov r22, c100.yyyy // 0 starting value for sum
	mul r23, c76, r21.x // texel size * radius
	mul r23, r23, c44.y // multiply by resolution height
	mul r23, r23, c10.y // divide by 720
	mul r24, r23, r21.y // *2 for second ring
	mul r25, r23, r21.z // *3 for third ring

	// first ring

    mad r26.xy, r23, c100.xy, v0
    texld r26, r26, s2
	add r22, r22, r26

    mad r26.xy, r23, c100.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r23, c101.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r23, c101.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r23, c102.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r23, c102.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r23, c103.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r23, c103.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
// second ring

    mad r26.xy, r24, c104.xy, v0
    texld r26, r26, s2
	add r22, r22, r26

    mad r26.xy, r24, c104.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c105.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c105.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c106.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c106.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c107.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c107.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c108.xy, v0
    texld r26, r26, s2
	add r22, r22, r26

    mad r26.xy, r24, c108.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c109.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c109.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c110.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c110.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c111.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r24, c111.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
// third ring

    mad r26.xy, r25, c112.xy, v0
    texld r26, r26, s2
	add r22, r22, r26

    mad r26.xy, r25, c112.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c113.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c113.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c114.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c114.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c115.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c115.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c116.xy, v0
    texld r26, r26, s2
	add r22, r22, r26

    mad r26.xy, r25, c116.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c117.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c117.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c118.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c118.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c119.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c119.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c120.xy, v0
    texld r26, r26, s2
	add r22, r22, r26

    mad r26.xy, r25, c120.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c121.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c121.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c122.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c122.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c123.xy, v0
    texld r26, r26, s2
	add r22, r22, r26
	
    mad r26.xy, r25, c123.zw, v0
    texld r26, r26, s2
	add r22, r22, r26
