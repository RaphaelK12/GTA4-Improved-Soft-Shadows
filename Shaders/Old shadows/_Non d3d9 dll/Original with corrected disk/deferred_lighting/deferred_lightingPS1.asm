...
//
	...
	// GTA4 original poison disk 12 samples
    ...
    def c97,  0.250, 1.0, 2.0, 1 // xy is texture scale multiplicator, z main filter size, w not used yet.
    ...
    mov r1.y, c53.y
 	...
 	// new, using r10+ registers 
	mul r10.xy, r1.yy, c97.xy		// filter xy
	mul r10.xy, r10.xy, c97.z		// filter scale
	
	mad r1.xw, r10.xy, c13.xyzy, r0.zyzw
    texld r2, r1.xwzw, s15
    add r1.x, r1.z, -r2.x
    cmp r1.x, r1.x, c3.x, c3.y
	
    mad r2.xy, r10.xy, c13.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c12, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c12.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c11, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c11.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c10, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c10.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c9, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c9.zwzw, r0.zwzw
    texld r2, r2, s15
    add r1.w, r1.z, -r2.x
    cmp r1.w, r1.w, c3.x, c3.y
    add r1.x, r1.x, r1.w
	
    mad r2.xy, r10.xy, c8, r0.zwzw
    mad r0.zw, r10.xy, c8, r0
