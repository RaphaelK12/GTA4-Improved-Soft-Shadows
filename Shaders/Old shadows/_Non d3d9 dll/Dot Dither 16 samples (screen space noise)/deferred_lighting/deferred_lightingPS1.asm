...
//
	...
	// def c10, 12.9898, 78.233, 43758.5453, 3.14 // constants
	// def c11, 1.0, -1.0, 0.0, 0.0 // constants

	
	
	// added this
	def c96, -1, 0, 1, 2 	// pixels offsets
    def c97,  0.750, 3.0, 0.25, 1 // texture rescale multiplicator (the shader is made to work with a square texture, but provides a 4x larger in horizontal)
    ...
    rsq r0.y, r0.y
    rcp r0.y, r0.y // shadows fade out?
